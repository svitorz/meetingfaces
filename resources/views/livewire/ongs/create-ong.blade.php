...
<div class="ly d-flex align-items-center py-4 bg-body-white">
    ...
    <div x-cloak x-show="formStep === 1"></div>
    <div x-cloak x-show="formStep === 2"></div>
    <div x-cloak x-show="formStep === 3"></div>
    <button x-cloak x-show="formStep > 1" @click="formStep -= 1" type="button"
        class="bg-yellow-500 hover:bg-blue-700 text-black font-bold py-2 px-4 rounded">
        Voltar
    </button>
        ...
        <form class=" mx-auto d-block p-5 mt-5 bg-white shadow-lg mb-5 bg-body-tertiary rounded"
            ...
            <div class="row">
                ...
                <div class=" mb-3 col-4  ">
                    ...
                    <x-text-input wire:model="sigla" id="sigla" class="block mt-1 w-full" type="text"
                        name="sigla" required />
            ...
            <div class="row">
                ...
                <div class=" mb-3 col-2  ">
                    ...
                    <x-text-input wire:model="cep" id="cep" class="block mt-1 w-full" type="text"
                        x-mask="99999-999" name="cep" />
            ...
            <div class="row">
                <div class=" col-4  ">
                    ...
                    <x-text-input wire:model="cnpj" id="cnpj" class="block mt-1 w-full" type="text"
                        name="cnpj" x-mask="99.999.999/9999-99" pattern="([0-9]{2})[0-9]{5}-[0-9]{4}" required />
            ...
            <div class="col mt-5">
                <a href="inicio.php" class="btn btn-outline-dark w-20 py-2 col-6 d-grid gap-2 mx-auto"
                    type="submit">
                    Cadastrar
                </a>
            </div>
