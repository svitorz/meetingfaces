...
<div>
    ...
    <div
        class="mt-5 col-lg-4 col-sm-12 col-md-6 justify-content-center offset-md-4 bg-white shadow-lg p-3 mb-5 bg-body-tertiary rounded">
        <form wire:submit="login">
            <!-- Email Address -->
            <div class="form-floating col-lg-6 col-sm-12 col-md-9 d-grid gap-2 mx-auto">
            ...
            <!-- Password -->
            <div class="form-floating mb-3 col-lg-6 col-sm-12 col-md-9 d-grid gap-2 mx-auto">
            ...
            <div class="flex items-center justify-end mt-4 d-block">
                ...
                <a class="col-5 d-grid gap-2 mx-auto text-primary" href="{{ route('password.request') }}" wire:navigate>
