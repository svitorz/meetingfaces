<div class="container">
    ...
    <div class="d-flex justify-content-center p-2">
        <form class="col-6 mb-3 me-3 ms-3" role="search" width="100px" action="{{ route('morador.find') }}" method="GET">
            <div class="input-group">
                ...
                <button class="input-group-text border-0 border-top border-bottom" type="button"
                    x-on:click="$wire.removeInputText()">
                ...
                <select name="cidade" id="search_city" class="border">
