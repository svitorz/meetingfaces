        ...
        wire:submit="update" @endif
          ...
          <div class="row">
              ...
              <div class="mb-3 col-6">
                  ...
                  <x-text-input wire:model="nome_completo" id="nome_completo" class="tw-block tw-mt-1 tw-w-full" type="text"
                      name="nome_completo" />
              ...
              <div class="mb-3 col-6">
                  ...
                  <x-text-input wire:model="nome_familiar_proximo" id="nome_familiar_proximo" class="tw-block tw-mt-1 tw-w-full"
              ...
              <div class="col-12">
                <x-input-label for="profile_picture" :value="__('Foto para perfil')" />
                    <x-text-input wire:model="profile_picture" id="profile_picture" class="tw-block tw-mt-1 tw-w-full" type="file"
